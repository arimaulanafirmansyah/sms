...
\033[37m    /_/ \033[32m \033[37mSPAM SMS \033[33mMatahari \033[32m| \033[37mBY \033[33mLETTA-SAMA \033[32m
\033[32m[•]───────────────────────────────────────────[•]
\033[32m | [☁️]  Author  : Kannachann 	               |
\033[32m | [☁️]  Github  : Kannachann                   |
\033[32m | [☁️]  IG      : ppiowy_		       |
\033[32m[•]───────────────────────────────────────────[•]"""
os.system('clear')
print (banner)
print ('%s[%s📮%s] %sIP Kamu %s: %s%s' % (p,h,p,k,m,h,ip))
no = input('\n\033[37m[\033[33m❓\033[37m] \033[33mExample \033[31m: \033[32m08xx\n\033[37m[\033[32m💬\033[37m] \033[33mPhone\033[31m:\033[32m ')
if no =='':
...
for i in range(jml):
      ...
      if 'Success' in sec.text:
           print(f'\033[37m[\033[35m{i+1}\033[37m] \033[33mMessage \033[31m: \033[32mSpam Succes Terkirim...')
      else:
           print(f'\033[37m[\033[35m{i+1}\033[37m] \033[33mMessage \033[31m: \033[31mSpam Sms Gagal')
      time.sleep(1.5)
print ('\n\033[37m[\033[32m✅\033[37m] \033[37mSpam Selesai \033[33m ✔️')
